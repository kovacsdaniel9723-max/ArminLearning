...
export const PATTERN_TASKS: PatternTask[] = [
  ...
  { sequence: [100, 90, 80, 70], options: [65, 60, 55], correctIndex: 1 },
  { sequence: [2, 4, 8, 16], options: [24, 32, 20], correctIndex: 1 },
  ...
  { sequence: [64, 32, 16, 8], options: [6, 4, 2], correctIndex: 2 },
];
